...
/* For polygons coordinates */
    ...
    var cyprus = L.tileLayer('../../../assets/images/cyprus_tiles/{z}/{x}/{y}.png', {
        minZoom: 0,
        maxZoom: 13,
        attribution: 'Map data: Lands and Surveys of Cyprus - Eratosthenes. Tiles: Generated by TilesXYZ'
      }); 
    ...
    var baseMaps = {"DARE": dare, "Terrain": terrain, "Watercolor": watercolor, "Open Street Map": osm, "Cyprus": cyprus};
    var overlayMaps = { };
    var layers = [cyprus, osm, terrain, watercolor];
