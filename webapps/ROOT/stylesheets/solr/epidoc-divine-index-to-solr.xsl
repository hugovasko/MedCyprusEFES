...
<xsl:stylesheet exclude-result-prefixes="#all"
  ...
  <xsl:template match="/">
    <add>
      <xsl:for-each-group select="//tei:rs[@type='divinities']|//tei:persName[@type='divine' or @type='sacred']" group-by="concat(@ref, '-', @key, '-', string-join(descendant::tei:addName/@nymRef, ' '), '-', string-join(descendant::tei:rs[@type='epithet']/@key, ' '))">
        ...
        <doc>
          ...
          <field name="index_item_type">
            <xsl:value-of select="@subtype"/> <!-- Mentioned/Depicted -->
          </field>
  ...
  <xsl:template match="tei:rs[@type='divinities']|tei:persName[@type='divine' or @type='sacred']">
